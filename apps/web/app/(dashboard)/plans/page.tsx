...
import { ArrowRight, MapPin, Users, Inbox, PlusCircle } from "lucide-react";
            ...
            <Card key={plan.id} className="relative overflow-hidden p-5">
              ...
              <div className="relative space-y-4">
                <div className="flex items-start justify-between gap-3">
                  ...
                  <Link href={`/dashboard/plans/${plan.id}/offers`}>
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <Link href={`/dashboard/plans/${plan.id}/offers`} className="inline-flex items-center gap-1.5 text-sm font-semibold text-[var(--color-sea-700)] hover:text-[var(--color-sea-800)] transition">
                    Review offer inbox
